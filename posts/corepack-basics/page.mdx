...
description: What Corepack is and how it pins package manager versions for Node.js projects.
date: 01-06-2023
...
<BlogHeader
  title="Corepack Basics"
  date="01-06-2023"
  slug="corepack-basics"
  image={{
    path: "/corepack-basics/package.avif?tx=q_auto,c_crop,g_south",
    alt: "A picture of a package",
  }}
/>
