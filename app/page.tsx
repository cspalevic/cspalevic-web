      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:py-12">
        <article className="space-y-6 text-base leading-relaxed text-secondary-foreground">
          ...
          <p>
            ...
            <LinkText text="Spraying Systems" href="https://www.spray.com" />.
          ...
          <p>
            ...
            Checkout and grew into lead roles on some of its larger initiatives.
            I helped modernize PayPal Checkout onto Next.js — a surface that
            handles millions of transactions globally. Along the way I've spent
            a lot of time on A/B experimentation, performance, observability
          ...
          <p>
            ...
            <LinkText text="Chavo" href="https://chavo.app/" />. The basic idea
            is to have a personal trainer in my pocket. Previously, I would have
