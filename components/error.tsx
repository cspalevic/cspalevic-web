...
const ErrorReporter = ({ error }: ErrrProps) => {
  ...
  return (
    <div className="flex h-full w-full flex-1 flex-col items-center justify-center px-5">
      ...
      <svg className="h-auto w-full" viewBox="0 0 1120.59226 777.91584">
        ...
        />
        <path fill="#0078d4" opacity={0.4} d="M271.609 150h16v16h-16z" />
        <path fill="#0078d4" opacity={0.8} d="M294.609 150h16v16h-16z" />
        <path fill="#0078d4" d="M317.609 150h16v16h-16z" />
        <path fill="#0078d4" opacity={0.4} d="M271.609 251h16v16h-16z" />
        <path fill="#0078d4" opacity={0.8} d="M294.609 251h16v16h-16z" />
        <path fill="#0078d4" d="M317.609 251h16v16h-16z" />
        <path fill="#0078d4" opacity={0.4} d="M271.609 352h16v16h-16z" />
        <path fill="#0078d4" opacity={0.8} d="M294.609 352h16v16h-16z" />
        <path fill="#0078d4" d="M317.609 352h16v16h-16z" />
